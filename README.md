...
Scripts were written and run on MacOS Seqouia 15.6.1 in RStudio, using R version 4.5.2. Users require R to be installed on their computer in order to run the scripts. https://cran.r-project.org/  
