...
#Whereever 'Your path here' appears as a comment, please replace with the correct pathway to your local file
...
window = 20 #Start with a 20-yr window for simplicity, but 10-yr and 50-yr also of interest
