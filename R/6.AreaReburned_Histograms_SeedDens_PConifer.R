...
#Core area thresholds identified in modelling script (5)
#Can modify this distance if interested in a different core area definition.
...
#What proportion is core area, as a function of patch size
...
corearea.size = ggplot(corearea.long, aes(fill=Seed_Risk, y=AREA_Ha, x=bin)) + 
  ...
  scale_y_continuous(expand = expansion(mult=c(0,0.05)),
                     ...
                     #Be careful with the relabeled scale. Might not match your values
...
#Let's see how the trajectories stack up across the distribution of climate predictors
climdat = read.csv(#Your path here
  "/Users/ewhitman/Documents/Projects/Reburn_Occurence_2023/Data/Regen_Trajectories_Data_March272026.csv")
...
#BE VERY CAREFUL! THESE VALUES CORRESPOND SPECIFICALLY TO THIS DATASET
#If you produced your own data, these numbers will be different.
gdd.broad[2,"AREA_Ha"] = 4913
gdd.broad[9,"AREA_Ha"] = 1206
gdd.broad = gdd.broad[-c(1,10,11,12),]

gdd.con[4,"AREA_Ha"] = 3233
gdd.con[11,"AREA_Ha"] = 820
gdd.con = gdd.con[-c(1,2,3,12,13),]

gdd.sparse[3,"AREA_Ha"] = 3145
gdd.sparse[10,"AREA_Ha"] = 33
gdd.sparse[10,"bin"] = "[1300,1400)"
gdd.sparse=gdd.sparse[-c(1,2,11),]

gdd.binsums = rbind(gdd.con,gdd.broad)
gdd.binsums = rbind(gdd.binsums,gdd.sparse)
head(gdd.binsums)

gdd.binsums2[4,"AREA_Ha"] = 14131
gdd.binsums2[11,"AREA_Ha"] = 4007
...
#This is basically the same as in script 5
